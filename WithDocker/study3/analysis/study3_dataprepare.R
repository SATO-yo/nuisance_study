...
# data.original <-
#   readxl::read_xlsx("/home/rstudio/NuisanceStudy/study3/data/study3_data_raw.xlsx",
#                     sheet = "Sheet0", col_names = T
#   )
# # write.csv(data.original, "data/data_original.csv", row.names = F, col.names = T)
# 
# data.clean <-
#   data.original %>%
...
# write.csv(
#   data.clean,
#   "/home/rstudio/NuisanceStudy/study3/data/data_study3_public.csv",
#   row.names = FALSE
# )
...
data.clean <-
  read.csv("/home/rstudio/NuisanceStudy/study3/data/data_study3_public.csv", header = TRUE)
